...
export const openAiNativeModels = {
	"gpt-6-sol": {
		...
		description: "GPT-6 Sol: Built to power complex coding and agentic workflows",
	},
	"gpt-6-luna": {
		maxTokens: 128000,
		contextWindow: 1_050_000,
		...
		description: "GPT-6 Luna: Our most efficient model for focused, high-volume tasks",
	},
	"gpt-6-astra": {
		maxTokens: 128000,
		contextWindow: 1_050_000,
